" Vim colorscheme
" Adapted from Kafka colorscheme from: https://github.com/Konstruktionist/vim
...
" Diff
" --------------------------------
hi DiffAdd         ctermfg=34       ctermbg=0      cterm=NONE        guifg=#00af00     guibg=NONE        gui=NONE
hi DiffChange      ctermfg=5        ctermbg=0      cterm=NONE        guifg=#d743da     guibg=NONE        gui=NONE
hi DiffDelete      ctermfg=1        ctermbg=0      cterm=NONE        guifg=#b91e2e     guibg=NONE        gui=NONE
hi DiffText        ctermfg=229      ctermbg=0      cterm=NONE        guifg=#ffffaf     guibg=NONE        gui=NONE
hi DiffAdded       ctermfg=34       ctermbg=0      cterm=NONE        guifg=#00af00     guibg=NONE        gui=NONE
hi DiffFile        ctermfg=6        ctermbg=0      cterm=NONE        guifg=#6193bc     guibg=NONE        gui=NONE
hi DiffNewFile     ctermfg=34       ctermbg=0      cterm=NONE        guifg=#00af00     guibg=NONE        gui=NONE
hi DiffLine        ctermfg=229      ctermbg=0      cterm=NONE        guifg=#ffffaf     guibg=NONE        gui=NONE
hi DiffRemoved     ctermfg=1        ctermbg=0      cterm=NONE        guifg=#b91e2e     guibg=NONE        gui=NONE
" --------------------------------
" Completion menu
" --------------------------------
